...
export const seedProducts: SeedProduct[] = [
  ...
  { name: "Флэш Ягодный (ж/б, все виды)", category: Category.ENERGY, volumeMl: 440, purchasePrice: 63, caseSize: 24, imageUrl: "/flash-yagodniy-jb.jpg" },
  ...
  { name: "Power Torr Манго (ПЭТ, все виды)", category: Category.ENERGY, volumeMl: 1000, purchasePrice: 90, caseSize: 6, imageUrl: "/power-torr-mango-pet.jpg" },
  { name: "Power Torr синий (ПЭТ, все виды)", category: Category.ENERGY, volumeMl: 500, purchasePrice: 59, caseSize: 12, imageUrl: "/power-torr-siniy-pet.jpg" },
  { name: "Lit Energy Персик (все виды)", category: Category.ENERGY, volumeMl: 450, purchasePrice: 73, caseSize: 12, imageUrl: "/lit-energy-peach.jpg" },
  ...
  { name: "Добрый Фанта (ПЭТ, все виды)", category: Category.OTHER, volumeMl: 500, purchasePrice: 54, caseSize: 24, imageUrl: "/dobriy-fanta-pet.jpg" },
